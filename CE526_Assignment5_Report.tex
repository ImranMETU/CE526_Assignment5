...
\begin{enumerate}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{partA_nodenumbering.png}
        \caption*{(a) Part A node numbering.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{partA_elementshapes.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{partB_elementnumbering.png}
        \caption*{(a) Part B node and element numbering.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{partB_elementshapes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partA_side_y_minus1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partA_side_y_0.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partA_side_y_1.png}
\caption{Part A one-dimensional side-view nodal plot along the line $y=1$.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partA_2D_nodal_map.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partA_2D_contour.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partA_3D_points_only.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partB_side_y_minus1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partB_side_y_0.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partB_side_y_1.png}
\caption{Part B one-dimensional side-view nodal plot along the line $y=1$.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partB_2D_nodal_map.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partB_2D_cell_average_map.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{partB_3D_points_only.png}
